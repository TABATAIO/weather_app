...
/**
 * 風向変換関数
 * @param {number} windDirectionCode - 風向コード
 * @returns {string} 風向名
 */
 ...
 * @returns {Object} 緯度経度情報
 */
function getCityCoordinates(cityName) {
  const cityCoords = {
    'tokyo': { lat: 35.6762, lon: 139.6503, name: '東京', fullName: '東京都千代田区' },
    'osaka': { lat: 34.6937, lon: 135.5023, name: '大阪', fullName: '大阪府大阪市' },
    'kyoto': { lat: 35.0116, lon: 135.7681, name: '京都', fullName: '京都府京都市' },
    'yokohama': { lat: 35.4478, lon: 139.6425, name: '横浜', fullName: '神奈川県横浜市' },
    'nagoya': { lat: 35.1815, lon: 136.9066, name: '名古屋', fullName: '愛知県名古屋市' },
    'fukuoka': { lat: 33.5904, lon: 130.4017, name: '福岡', fullName: '福岡県福岡市' },
    'sendai': { lat: 38.2682, lon: 140.8694, name: '仙台', fullName: '宮城県仙台市' },
    'hiroshima': { lat: 34.3853, lon: 132.4553, name: '広島', fullName: '広島県広島市' }
  };
...
async function fetchWeatherData(lat, lon) {
  ...
  if (!wxdata || !wxdata.srf || !Array.isArray(wxdata.srf)) {
    throw new Error('Weathernews APIレスポンスの構造が予期しない形式です');
  }
